...
export const EcomHeroBlock: React.FC<Props> = async ({
  ...
  return (
    <section className="w-full overflow-hidden bg-background pt-8 pb-12">
      <div className="container mx-auto">
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-accent to-background px-6 py-16 md:px-16 md:py-24 border border-border shadow-sm flex flex-col md:flex-row items-center justify-between">
