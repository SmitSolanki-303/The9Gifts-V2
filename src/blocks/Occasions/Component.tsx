...
export const OccasionsBlock: React.FC<Props> = async ({
    ...
    occasions = [
      {
        ...
        description:
          'Make their day special with customized apparel, mugs, and curated birthday hampers.',
      ...
      },
      {
        ...
        description:
          'Express your love with personalized keepsakes, frames, and premium couple gifts.',
      ...
      },
      {
        ...
        description:
          'Celebrate the season with exclusive hampers and traditional gifting collections.',
  ...
  return (
    <section className="w-full" id="occasions">
      <div className="container mx-auto">
        <div className="bg-accent/30 rounded-3xl py-12 px-6 md:px-12 md:py-16 mt-4 mb-4">
          <div className="mx-auto mb-12 max-w-2xl text-center">
            {subtitle && (
              <p className="mb-3 text-[11px] uppercase tracking-atelier text-primary">{subtitle}</p>
            )}
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {occasions.map((occasion, i) => {
              const img =
                typeof occasion.image === 'object' && occasion.image?.url
                  ? occasion.image.url
                  : occasion.image
              return (
                <Link
